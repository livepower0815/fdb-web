<template>
  <div style="background-color: #ffffff; height: 596px; color: #616161; letter-spacing: 0.015em; font-family: Roboto">
    <div style="width: 350px; margin: 0 auto; padding: 28px">
      ...
      <div style="border-top: 2px #eeeeee solid; border-bottom: 2px #eeeeee solid; padding: 30px 20px">
        <p style="margin-bottom: 40px">尊敬的會員您好： <br />恭喜您成為Fundobit會員</p>
