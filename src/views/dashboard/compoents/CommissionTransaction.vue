    ...
    <table class="info-table">
      <thead>
        <tr>
          ...
          <th>
            <TableFilter v-model="queryForm.changeType" :title="$t('change_type')" :items="changeTypeMap" />
          </th>
          <th @click="sortData('changeNum')">
            <Sort :title="$t('change_number')" sort="changeNum" :sort-key="pager.sortKey" :order="pager.order" />
          </th>
          <th @click="sortData('restNum')">
            <Sort :title="$t('rest_number')" sort="restNum" :sort-key="pager.sortKey" :order="pager.order" />
          </th>
        </tr>
      </thead>
      <tbody>
