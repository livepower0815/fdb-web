  ...
  <div class="outline" id="recommender-refund">
    <div class="refund-detail-filter-block">
      <div class="refund-detail-filter-main">
        <a href="" class="icon" :class="{ active: filterForm.currencyType === 'all' }" @click.prevent="filterForm.currencyType = 'all'">
        ...
        <a href="" class="icon" :class="{ active: filterForm.currencyType === 'BTC' }" @click.prevent="filterForm.currencyType = 'BTC'">
        ...
        <a href="" class="icon" :class="{ active: filterForm.currencyType === 'USID' }" @click.prevent="filterForm.currencyType = 'USID'">
        ...
        <a href="" class="icon" :class="{ active: filterForm.currencyType === 'EOS' }" @click.prevent="filterForm.currencyType = 'EOS'">
        ...
        <a href="" class="icon" :class="{ active: filterForm.currencyType === 'XRP' }" @click.prevent="filterForm.currencyType = 'XRP'">
        ...
        <a href="" class="icon" :class="{ active: filterForm.currencyType === 'ETH' }" @click.prevent="filterForm.currencyType = 'ETH'">
