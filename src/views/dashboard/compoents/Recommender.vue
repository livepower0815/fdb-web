  ...
  <div class="outline" id="recommender-refund">
    <div class="refund-detail-filter-block">
      <div class="refund-detail-filter-main">
        <a href="" class="icon" :class="{ active: currencyType === 'all' }" @click.prevent="currencyType = 'all'">
        ...
        <a href="" class="icon" :class="{ active: currencyType === 'BTC' }" @click.prevent="currencyType = 'BTC'">
        ...
        <a href="" class="icon" :class="{ active: currencyType === 'USID' }" @click.prevent="currencyType = 'USID'">
        ...
        <a href="" class="icon" :class="{ active: currencyType === 'EOS' }" @click.prevent="currencyType = 'EOS'">
        ...
        <a href="" class="icon" :class="{ active: currencyType === 'XRP' }" @click.prevent="currencyType = 'XRP'">
        ...
        <a href="" class="icon" :class="{ active: currencyType === 'ETH' }" @click.prevent="currencyType = 'ETH'">
      ...
      <div class="outblock">
        <div class="mobile-refund-detail-info-block">
          <div class="outline">
            ...
            <a href="javascript:void(0)" class="mobile-refund-btn">管理組別</a>
            <a href="javascript:void(0)" class="mobile-refund-btn">編輯組別</a>
          </div>
